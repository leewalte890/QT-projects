...
OBJECTFILES= \
	...
	${OBJECTDIR}/LargeCharacterFactory.o \
	${OBJECTDIR}/MedCharacter.o \
	${OBJECTDIR}/MedCharacterFactory.o \
	${OBJECTDIR}/SmallCharacter.o \
	${OBJECTDIR}/SmallCharacterFactory.o \
	${OBJECTDIR}/main.o
...
${OBJECTDIR}/LargeCharacterFactory.o: LargeCharacterFactory.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LargeCharacterFactory.o LargeCharacterFactory.cpp
...
${OBJECTDIR}/MedCharacterFactory.o: MedCharacterFactory.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MedCharacterFactory.o MedCharacterFactory.cpp
...
${OBJECTDIR}/SmallCharacterFactory.o: SmallCharacterFactory.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SmallCharacterFactory.o SmallCharacterFactory.cpp
